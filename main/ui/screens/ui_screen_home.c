...
lv_timer_t * g_timer_update;
lv_coord_t y_points[NUM_SAMPLES];
//////////////// STATIC FUNCTION ////////////////
...
static void add_chart_data(lv_timer_t * t)
{
...
//////////////// EVENT CALLBACK ////////////////
static void ui_event_chart(lv_event_t * e)
{
    lv_event_code_t code = lv_event_get_code(e);
    lv_obj_t * chart = lv_event_get_target(e);
    chart_cursor_t * chart_cursor = lv_event_get_user_data(e);
    // printf("chart_cursor: %p", chart_cursor);
    static int id1 = -1;
    static int id2 = -1;
    if (code == LV_EVENT_DRAW_PART_END) {
        // printf("gfasgsag\n");
        lv_point_t point1 = lv_chart_get_cursor_point(chart, chart_cursor->cursor1);
        lv_point_t point2 = lv_chart_get_cursor_point(chart, chart_cursor->cursor2);
        // id1 = point1.x;
        // id2 = point2.x;
        id1 = 200;
        id2 = 600;
        ...
        // printf("%p\t%p\t%d\t%d\t%d\n",dsc->p1, dsc->p2, dsc->p1->y != dsc->p2->y, id1, id2);
        if(dsc->p1 == NULL || dsc->p2 == NULL || id1 < 0 || id2 < 0) return;
        // printf("xzvczxbbxbcvzbx\n");
        ...
        lv_draw_rect(dsc->draw_ctx, &draw_rect_dsc, &a1);
        lv_draw_rect(dsc->draw_ctx, &draw_rect_dsc, &a2);
        ...
        a2.y1 += 5;
        a2.y2 -= 5;
        lv_draw_label(dsc->draw_ctx, &draw_label_dsc, &a1, buf1, NULL);
        lv_draw_label(dsc->draw_ctx, &draw_label_dsc, &a2, buf2, NULL);
    }
}
static void ui_event_textarea(lv_event_t * e)
{
    lv_event_code_t code = lv_event_get_code(e);
...
static void ui_event_kbnumpad(lv_event_t * e)
{
    lv_event_code_t code = lv_event_get_code(e);
...
static void ui_event_screen_home(lv_event_t * e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    lv_obj_t * chart = lv_event_get_user_data(e);
    if (event_code == LV_EVENT_SCREEN_LOAD_START) {
        g_timer_update = lv_timer_create(add_chart_data, 1, chart);
    }
}

static void ui_event_slider_voltage(lv_event_t * e)
{
...
static void ui_event_slider_samp_freq(lv_event_t * e)
{
    lv_obj_t * slider = lv_event_get_target(e);
    lv_obj_t * ta = lv_event_get_user_data(e);
    char buf[20];
...
static void ui_event_slider_samp_time(lv_event_t * e)
{
    lv_obj_t * slider = lv_event_get_target(e);
    lv_obj_t * ta = lv_event_get_user_data(e);
    char buf[20];
...
static void ui_event_button_start(lv_event_t * e)
{
...
{
    lv_style_t * custom_style = get_custom_style();
    ...
    lv_obj_add_style(ui_ScreenHome_PanelFunc_PanelMode_PanelOutput_SwitchOp, &custom_style[SWITCH], 0);
    ...
    lv_chart_set_point_count(ui_ScreenHome_PanelDisp_ChartDisp, NUM_SAMPLES * 2);
    ...
    lv_chart_set_range(ui_ScreenHome_PanelDisp_ChartDisp, LV_CHART_AXIS_PRIMARY_Y, -100, 100);
    chart_cursor_t chart_cusor = {
    ...
    lv_obj_add_style(ui_ScreenHome_PanelDisp_PanelOption_PanelLocky_SwitchLocky, &custom_style[SWITCH], 0);
    ...
    lv_obj_add_style(ui_ScreenHome_PanelDisp_PanelOption_PanelRtview_SwitchRtview, &custom_style[SWITCH], 0);
    ...
    lv_obj_add_event_cb(ui_ScreenHome, ui_event_screen_home, LV_EVENT_ALL, ui_ScreenHome_PanelDisp_ChartDisp);
    lv_obj_add_event_cb(ui_ScreenHome_PanelFunc_PanelMode_SliderVsup, ui_event_slider_voltage, LV_EVENT_VALUE_CHANGED, ui_ScreenHome_PanelFunc_PanelMode_PanelVsup_TextareaVsup);
    lv_obj_add_event_cb(ui_ScreenHome_PanelFunc_PanelParam_SliderFreq, ui_event_slider_samp_freq, LV_EVENT_VALUE_CHANGED, ui_ScreenHome_PanelFunc_PanelParam_LabelSubtitle1);
    lv_obj_add_event_cb(ui_ScreenHome_PanelFunc_PanelParam_SliderTs, ui_event_slider_samp_time, LV_EVENT_VALUE_CHANGED, ui_ScreenHome_PanelFunc_PanelParam_PanelTs_TextareaTs);
    lv_obj_add_event_cb(ui_ScreenHome_PanelDisp_KbNumpad, ui_event_kbnumpad, LV_EVENT_ALL, ui_ScreenHome_PanelFunc_PanelMode_PanelVsup_TextareaVsup);
    lv_obj_add_event_cb(ui_ScreenHome_PanelFunc_PanelMode_PanelVsup_TextareaVsup, ui_event_textarea, LV_EVENT_ALL, ui_ScreenHome_PanelFunc_PanelMode_SliderVsup);
    lv_obj_add_event_cb(ui_ScreenHome_PanelFunc_PanelOption_ButtonStart, ui_event_button_start, LV_EVENT_VALUE_CHANGED, ui_ScreenHome_PanelFunc_PanelOption_ButtonStart_LabelMark);
    lv_obj_add_event_cb(ui_ScreenHome_PanelFunc_PanelParam_PanelTs_TextareaTs, ui_event_textarea, LV_EVENT_ALL, ui_ScreenHome_PanelFunc_PanelParam_SliderTs);
    // lv_obj_add_event_cb(ui_ScreenHome_PanelDisp_ChartDisp, ui_event_chart, LV_EVENT_ALL, &chart_cusor);
